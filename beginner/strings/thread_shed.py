...
def color_count(color):
    count = 0
    for string in thread_sold_split:
        if color == string:
            count += 1
    return count
...
for color in colors:
    color_tally = color_count(color)
    print("A total of {tally} spools of {color} were sold today.".format(tally=color_tally, color=color))
